...
const pages = [
  ...
  {
    path: "pages/add/dynamic",
    style: {
      navigationBarTitleText: "发布动态"
    }
  },
  {
    path: "pages/add/activity",
    style: {
  ...
  {
    path: "pages/me/friend-manage",
    style: {
      navigationBarTitleText: "好友管理"
    }
  },
  {
    path: "pages/me/my-published",
    style: {
      navigationBarTitleText: "我发布的活动"
    }
  },
  {
    path: "pages/me/my-joined",
    style: {
