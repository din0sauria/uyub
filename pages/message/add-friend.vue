<template>
	<view class="container">
		...
		<view class="form-item">
			...
			<input type="text" v-model="formData.friendId" class="input-field" placeholder="请输入对方ID"
		...
		<view class="form-item content-item">
			...
			<view class="textarea-container">
				<textarea v-model="formData.message" class="textarea-field" placeholder="请输入验证信息（可选）"
